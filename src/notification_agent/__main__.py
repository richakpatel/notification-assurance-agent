"""
Console demo for the Customer Notification Assurance Agent.
...
Run it any of these ways:
    ...
    python3 scripts/run_demo.py             (zero-install, from a clone)
    notification-agent-demo                 (console script entry point)
"""

from __future__ import annotations

from .agent import NotificationAssuranceAgent
from .model import MAS, MCN, THRESHOLD
